...
extern void D3DState_SetDefaults( void );
extern void D3DState_Apply( D3DState_t *state, GLbitfield mask );
extern bool D3DState_SetMatrixMode( const D3DState_t *state );
extern void D3DState_SetCullMode( const D3DState_t *state );
extern void D3DState_SetDepthBias( const D3DState_t *state );
extern void D3DState_AssureBeginScene( void );
extern void D3DState_Check( void );
