...
// Get* functions
//-----------------------------------------
// We will maintain our own state and return
// it, not query Direct3D state. This is
// essential if we use pure device that
// actually forbids any get requests
//=========================================
...
OPENGL_API GLenum WINAPI glGetError( void )
{
...
OPENGL_API HRESULT WINAPI glGetD3DError( void )
{
