...
// Texture generation
//-----------------------------------------
// We implement OpenGL texgen functionality
// in software since D3D's is very poor, and
// we don't want to use vertex shaders
//=========================================
...
static void TexGenFunc_None( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	*output_texcoord = (coord == 3) ? 1.0f : 0.0f;
}

static void TexGenFunc_ObjectLinear( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
...
static void TexGenFunc_ObjectLinear_SSE( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
...
static void TexGenFunc_EyeLinear( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
...
static void TexGenFunc_EyeLinear_SSE( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	_declspec(align(16)) float sse_vertex[4];
	_declspec(align(16)) float sse_plane[4];
	float out_coord = 0.0f;
...
static void TexGenFunc_SphereMap( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	if (coord == 3) {
...
static void TexGenFunc_SphereMap_SSE( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	if (coord == 3) {
		*output_texcoord = 1.0f;
	} else if (coord == 2) {
...
static void TexGenFunc_ReflectionMap( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	if (coord == 3) {
		*output_texcoord = 1.0f;
	} else {
...
static void TexGenFunc_ReflectionMap_SSE( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	if (coord == 3) {
		*output_texcoord = 1.0f;
	} else {
...
static void TexGenFunc_NormalMap( int stage, int coord, const GLfloat *vertex, const float *normal, float *output_texcoord )
{
	if (coord == 3) {
		*output_texcoord = 1.0f;
	} else {
...
void SelectTexGenFunc( int stage, int coord )
{
	...
	case GL_OBJECT_LINEAR:
		...
		D3DState.TextureState.TexGen[stage][coord].trNormal = NULL;
		break;
	case GL_EYE_LINEAR:
	...
	case GL_NORMAL_MAP_ARB:
		...
		D3DState.TextureState.TexGen[stage][coord].trVertex = NULL;
		D3DState.TextureState.TexGen[stage][coord].trNormal = TrNormalFunc_TransformByModelview;
		break;
	default:
